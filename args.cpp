...
Args::Args(const int &argc, char const *argv[]) {
	...
	args = {Arg_Val(&rand_seed, 0, "-rand_seed", "RAND_SEED", "Value to seed RNG with."),
			...
			Arg_Val(&power_splitting_method, "offline", "-power_splitting_method", "OFF_OR_ON", "Whether power splitting should be performed online or offline. Must be either \"online\" or \"offline\""),
