...
SOURCES = main.cpp spectrum_manager.cpp generator.cpp args.cpp location.cpp split.cpp timer.cpp utils.cpp tables.cpp path_loss_table.cpp su_server.cpp key_server.cpp debug_print.cpp
